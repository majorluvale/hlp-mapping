$(window).on('load', function() {
  ...
  function onEachFeature(feature, layer) {
    ...
    var peopleInNeed = '<p><strong>' + feature.properties.pinF + '</strong> People in Need (2023)</p>';
    ...
    var linkBtn = '<div class="button btn-blue"><a href="'+ feature.properties.link + '">Go to the Country page</a>';
  ...
  function changeAttribution() {
    var disclaimer = '<p><small>The designations employed and the presentation of the material on this map do not imply the expression of any opinion whatsoever on the part of the "Housing, Land and Property Area Of Responsability" concerning the legal status of any country, territory, city or area or of its authorities, or concerning the delimitation of its frontiers or boundaries. Every effort is made to ensure this map is free of errors but there is no warrant the map or its features are either spatially or temporally accurate or fit for a particular use. This map is provided without any warranty of any kind whatsoever, either express or implied.</small></p>';
